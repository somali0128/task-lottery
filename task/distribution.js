      ...
      if (submissions == null) {
        ...
        for (let i = 0; i < size; i++) {
          ...
          if (
            ...
            if (votes.length === 0) {
              // No slash for now
              console.log(candidatePublicKey, ' is not the winner, good luck next time.')
              console.log('No stake slashes for beta version')
              // TODO: Transfer 1 KOII to target wallet address
            } else {
              let numOfVotes = 0;
